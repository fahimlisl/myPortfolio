...
const About = () => {
  return (
    <section className="relative min-h-screen flex flex-col justify-center items-center px-6 sm:px-10 py-24 overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[700px] sm:w-[900px] h-[700px] sm:h-[900px] bg-gradient-to-tr from-cyan-400/25 to-blue-600/25 blur-3xl opacity-40 rounded-full"></div>
      ...
      <motion.div
        ...
        className="w-full max-w-4xl bg-white/60 dark:bg-gray-800/60 backdrop-blur-xl rounded-2xl shadow-lg p-7 sm:p-10 border border-gray-200/40 dark:border-gray-700/40"
      >
        ...
        <div className="space-y-5 text-base sm:text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
          <p>
            ...
            who loves building clean server-side logic, secure APIs, and efficient data systems.
            I mostly work with{" "}
            <span className="font-medium text-blue-600 dark:text-cyan-400">
              Node.js, Express, and MongoDB
            </span>{" "}
            to create scalable backend architectures.
          </p>

          <p>
            While backend is my main playground, I also enjoy crafting smooth and responsive user
            interfaces with{" "}
            <span className="font-medium text-blue-600 dark:text-cyan-400">React</span> and{" "}
            <span className="font-medium text-blue-600 dark:text-cyan-400">TailwindCSS</span>.
            Understanding both frontend and backend flow helps me build complete, well-structured applications.
          </p>
          ...
          <p>
            ...
            .  
            I love solving real-world problems, exploring system design, and continuously leveling up my development skills.
          </p>
        </div>
